...
"""
blogging_for_humans documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'blogging_for_humans',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/blogging_for_humans",
...
#
# html_title = 'blogging_for_humans v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'blogging_for_humans',
     'Miscellaneous'),
]
