#!/usr/bin/env python
"""
Package metadata for blogging_for_humans.
"""
import os
import re
import sys
...
setup(
    ...
    version=VERSION,
    description="""blogging_for_humans""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Maciej',
    author_email='oscm@openedx.org',
    url='https://github.com/openedx/blogging_for_humans',
    packages=find_packages(
        include=['blogging_for_humans', 'blogging_for_humans.*'],
        exclude=["*tests"],
    ),
