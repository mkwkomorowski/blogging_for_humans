...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd blogging_for_humans && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd blogging_for_humans && i18n_tool generate

detect_changed_source_translations:
	cd blogging_for_humans && i18n_tool changed
...
pull_translations:
	find blogging_for_humans/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/blogging_for_humans/blogging_for_humans/conf/locale:blogging_for_humans/conf/locale
